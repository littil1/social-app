  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      <main className="mx-auto max-w-6xl px-4 pb-32 pt-6 sm:px-6 sm:pt-8 lg:px-8 lg:pt-12">
        ...
        <section className="mb-10 rounded-[30px] border border-amber-200/70 bg-white/85 p-5 shadow-[0_24px_70px_-54px_rgba(245,158,11,0.45)] backdrop-blur sm:mb-12 sm:p-6">
